...
use super::models::{ClaudeRequest, ContentBlock, Message, MessageContent, SystemPrompt, Tool};
use crate::proxy::mappers::signature_store::get_thought_signature;
use serde_json::{json, Value};
use std::collections::HashMap;

/// Fallback model for web search tool requests
...
impl SafetyThreshold {
    ...
    pub fn from_env() -> Self {
        match std::env::var("GEMINI_SAFETY_THRESHOLD").as_deref() {
            ...
            _ => SafetyThreshold::Off, // Default: OFF or unset
        }
    }
...
#[cfg(test)]
mod tests {
    use super::super::models::{ImageSource, ThinkingConfig};
    use super::*;
